import LogoMinted from "../images/logo_minted.jpeg";
import LogoMatrixAviation from "../images/logo_matrixaviation.jpeg";
import LogoYizmoD from "../images/logo_yizmod.jpeg";
import LogoGracom from "../images/logo_gracom.jpeg";
import LogoGVG from "../images/logo_gvg.jpeg";
import LogoAmChamSpain from "../images/logo_amchamspain.jpeg";
                        ...
                        <div className="col-sm-10 col-md-8 col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <h3>Matrix Aviation / San Francisco International Airport (SFO)</h3>
                                    ...
                                    <p className="card-text"><small className="text-muted">April 2018 - July 2019 <br /> San Francisco, CA -
                                        USA</small></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>Sénégal Tours</li>
                                        <li>Nouvelles Frontières Sénégal & West Africa</li>
                                        <li>Camino Senegal</li>
                                    ...
                                    <p className="card-text"><small className="text-muted">January 2015 - July 2017 / Dakar - SENEGAL</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        ...
                                        (Société d'Investissements Énergétiques - S.I.E.) of the Kingdom of Morocco.
                                    </p>
                                    <p className="card-text"><small className="text-muted">March 2014 - September 2016 / Casablanca -
                                        MOROCCO</small></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-sm-10 col-md-8 col-lg-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <h3>Global Voice Group</h3>


                                    <ul>
                                        <li>Head of the Commercial Support Department</li>
                                        <li>Project Director - Implementation of the Telecoms Traffic Management Solution (T.T.M.S.)</li>
                                        <li>Operations Director</li>
                                        <li>Head of the Document Writing Team - Elaboration of commercial proposals</li>
                                        <li>African Carriers Relations Manager</li>
                                    </ul>

                                    <p className="card-text"><small className="text-muted">September 2008 to January 2013<br /> Las Palmas
                                        de Gran Canaria - SPAIN; Dakar - SENEGAL; <br/>Accra - GHANA;
                                        Monrovia - LIBERIA</small></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>
                                        ...
                                        (european territory geographically located in Africa).
                                    </p>
                                    <p className="card-text"><small className="text-muted">June 2007 to September 2008 / Las Palmas de
                                        G.C. - SPAIN</small></p>
                                </div>
                            </div>
                        </div>
